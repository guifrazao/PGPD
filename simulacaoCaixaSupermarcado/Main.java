...
public class Main { 
    public static void main(String... args) { 
        ...
        System.out.printf("Média dos tempos de atendimento (%.0f simulações): %.4f min%n",(double) NUMERO_SIMULACOES, media);
        System.out.printf("Desvio-padrão das médias: %.4f min%n", dp);
    }
